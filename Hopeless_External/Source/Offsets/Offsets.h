...
namespace Offset
{
	inline DWORD EntityList = 0x1798738;
	inline DWORD ViewMatrix = 0x1886710;
	inline DWORD ViewAngle = 0x18E5740;
	inline DWORD LocalPlayerController = 0x17E7158;
	inline DWORD LocalPlayerPawn = 0x1885C28;
	inline DWORD ForceJump = 0x169E360;
	inline DWORD GlobalVars = 0x1699F40;
